// NAGS-UENR Application Configuration
const CONFIG = {
  ...
  ADMIN_PASSWORD: '#Nags@Uenr!',
  WHATSAPP_INVITE_LINK: 'https://chat.whatsapp.com/example-whatsapp-link',
  FACEBOOK_LINK: 'https://facebook.com/example-facebook-page'
};
